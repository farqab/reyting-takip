...
const BASE_URL = 'http://www.ranini.tv/reyting';
...
async function scrapeRatings() {
    ...
    try {
        ...
        // Look for links that contain a date or "Reyting Sonuçları"
        // ranini.tv usually lists articles. We want the first one that looks like a rating post.
